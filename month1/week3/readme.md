# YOLOv8n Baseline Evaluation on VisDrone2019-DET-val
...
- Model: YOLOv8n (official COCO pre-trained weights)
...
2. `yolov8n_visdrone_baseline.csv`: per-class and overall evaluation results
