...
class VisDroneBaselineEvaluator:
    def __init__(self, data_dir="./data"):
        # Load official yolov8s pretrained model
    ...
    def run_evaluation(self):
        ...
        predictions = []
        print("Running yolov8s baseline evaluation on VisDrone val set...")
        ...
        df.to_csv("yolov8s_visdrone_baseline.csv", index=False)

        # Print summary
        print("\n=== Baseline Evaluation Results ===")
        print(f"Overall mAP@0.5:      {mAP50}")
        print(f"Overall mAP@0.5:0.95: {mAP5095}")
        print("\nPer-class results saved to yolov8s_visdrone_baseline.csv")
